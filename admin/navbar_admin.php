<nav class="navbar navbar-expand-lg navbar-light bg-light" style="background: linear-gradient(to right, #ffffff, #ccedb6);">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="manage_habitats.php">Gérer Habitats</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="manage_animals.php">Gérer Animaux</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="manage_animal_reports.php">Gérer Rapports Vétérinaires</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="zoo_hours.php">Gérer Horaires</a>
            </li>
            <li class="nav-item">
