<nav class="navbar navbar-expand-lg navbar-light bg-light" style="background: linear-gradient(to right, #ffffff, #ccedb6);">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="add_animal_report.php">Ajouter Rapport</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="manage_animal_reports.php">Gérer Rapports</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="habitats.php">Habitats</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="manage_animals.php">Animaux</a>
            </li>
            <li class="nav-item">
