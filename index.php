...
<div class="container mt-5" style="background: linear-gradient(to right, #ffffff, #ccedb6);">
    <div class="container">
        ...
        <!-- Utilisation de card bootstrap pour afficher les habitats avec sa description et son bouton pour aller sur la page de l'habitat -->
                ...
                <div class="col-md-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="habitat.php?id=<?php echo $habitat['id']; ?>" class="btn btn-primary">Voir les détails</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
